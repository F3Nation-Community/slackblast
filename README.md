...
set `EMAIL_OPTION_HIDDEN_IN_MODAL` to `True` to not show the email option in the modal. The default is to show the option in the modal. Email will send if others options are set.
