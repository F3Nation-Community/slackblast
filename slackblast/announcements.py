...
msg += ":sports_medal: *Weaselbot Achievements!* - For those using <https://github.com/F3Nation-Community/weaselbot|Weaselbot>, you can now assign achievements to PAX directly without having to create a whole backblast for it. Use the `/tag-achievement` command to get started.\n\n"
msg += ":mechanic: *Under the Hood!* - Things like rich text input for backblasts, boyband image support, and better error handling.\n\n"
msg += "\nIf you have any questions or issues, the best way to reach out is on the #paxminer-slackblast channel in the Nation space.\n"
msg += "\n~ :moneybag: :baseball:"
